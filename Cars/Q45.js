...
function Cars(manufacturer, model_name) {
    var extraDetails = [];
    for (var _i = 2; _i < arguments.length; _i++) {
        extraDetails[_i - 2] = arguments[_i];
    }
    var car = __assign({ manufacturer: manufacturer, model_name: model_name }, Object.assign.apply(Object, __spreadArray([{}], extraDetails, false)));
    return car;
}
;
