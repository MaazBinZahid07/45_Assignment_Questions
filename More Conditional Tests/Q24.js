...
console.log('Inequality Test with String', "Mercedes" !== "BMW");
// Equality Test with String(For False)
console.log('Equality Test with String', "Mercedes" === "BMW");
// Inequality Test with String(For False)
console.log('Inequality Test with String', "Mercedes" !== "Mercedes");
...
console.log('OR Opertor Test', 20 === 7 || 20 >= 7);
// (For False)
console.log('And Opertor Test', 20 === 20 && 7 >= 20);
console.log('OR Opertor Test', 20 === 7 || 7 >= 2003);
// Array
